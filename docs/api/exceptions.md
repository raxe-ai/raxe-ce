...
try:
    ...
    print(f"Detections: {len(e.result.scan_result.l1_result.detections)}")
    ...
    try:
        ...
        return jsonify({
            ...
            "detections": [
                ...
                for d in e.result.scan_result.l1_result.detections
            ],
...
def scan_with_retry(text: str, max_retries: int = 3):
...
try:
    ...
    logger.warning(
        ...
        extra={
            ...
            "detections": len(e.result.scan_result.l1_result.detections)
        }
    )
```
...
try:
    ...
    # NOT THIS
    # return {"error": f"Rule {e.result.scan_result.l1_result.detections[0].rule_id} triggered"}, 403
```
