...
def process_user_input(user_input: str) -> str:
    """This function is automatically protected from threats."""
...
def process_input_with_logging(user_input: str) -> str:
    """Scan but don't block - just log threats."""
    return f"Processed: {user_input}"

# Threats are logged but not blocked
result = process_input_with_logging("malicious prompt")
...
raxe = Raxe(block_on_threat=True)
