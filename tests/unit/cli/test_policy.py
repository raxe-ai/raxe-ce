...
from tests.unit.cli.conftest import create_test_tenant
...
class TestPolicyList:
    ...
    def test_list_with_tenant_empty(self, runner, mock_tenant_path):
        """Test listing tenant policies when none exist."""
        create_test_tenant(runner, "acme", "Acme Corp")
    ...
    def test_list_with_tenant_has_policies(self, runner, mock_tenant_path):
    ...
    def test_list_json_output(self, runner, mock_tenant_path):
...
class TestPolicyCreate:
    ...
    def test_create_policy_success(self, runner, mock_tenant_path):
    ...
    def test_create_policy_with_custom_id(self, runner, mock_tenant_path):
    ...
    def test_create_policy_requires_tenant(self, runner):
    ...
    def test_create_policy_invalid_tenant(self, runner, mock_tenant_path):
    ...
    def test_create_policy_all_modes(self, runner, mock_tenant_path):
...
class TestPolicyShow:
    ...
    def test_show_tenant_policy(self, runner, mock_tenant_path):
...
class TestPolicyDelete:
    ...
    def test_delete_policy_success(self, runner, mock_tenant_path):
    ...
    def test_delete_nonexistent_policy(self, runner, mock_tenant_path):
    ...
    def test_cannot_delete_global_preset(self, runner, mock_tenant_path):
...
class TestPolicyCreateCustomMode:
    ...
    def test_create_custom_policy_with_thresholds(self, runner, mock_tenant_path):
    ...
    def test_create_custom_policy_shows_thresholds(self, runner, mock_tenant_path):
    ...
    def test_create_preset_ignores_threshold_options(self, runner, mock_tenant_path):
...
class TestPolicyUpdate:
    ...
    def test_update_policy_success(self, runner, mock_tenant_path):
    ...
    def test_update_policy_increments_version(self, runner, mock_tenant_path):
    ...
    def test_update_policy_changes_mode_to_custom(self, runner, mock_tenant_path):
    ...
    def test_update_nonexistent_policy(self, runner, mock_tenant_path):
    ...
    def test_cannot_update_global_preset(self, runner, mock_tenant_path):
    ...
    def test_update_requires_at_least_one_change(self, runner, mock_tenant_path):
...
class TestPolicyVersion:
    ...
    def test_new_policy_has_version_1(self, runner, mock_tenant_path):
        ...
        result = runner.invoke(policy, ["show", "v1-test", "--tenant", "acme", "--output", "json"])

        assert result.exit_code == 0
        data = json.loads(result.output)
        assert data["version"] == 1

    def test_policy_json_includes_version_fields(self, runner, mock_tenant_path):
