...
**🎉 First Public Beta Release - Production-Ready AI Security**

RAXE Community Edition v0.2.0 Beta is the first production-ready, open-source, privacy-first threat detection system for LLM applications. Built on transparency, not hype.
...
- **Rich L2 metadata sharing:**
  ...
  - ❌ NEVER prompts, responses, matched text, or hashes
...
[0.2.0]: https://github.com/raxe-ai/raxe-ce/releases/tag/v0.2.0
