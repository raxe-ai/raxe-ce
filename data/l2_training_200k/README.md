# L2 Prompt Injection Training Dataset - 200K Examples (v2.0)

## Overview

This comprehensive 200K training dataset (v2.0) for L2 prompt injection detection combines cutting-edge research from industry leaders and academia with production rule examples to create a robust, balanced dataset for training ONNX models.

**NEW in v2.0:**
- ✅ Doubled dataset size (100K → 200K)
- ✅ FlipAttack homoglyph variations (81-98% ASR)
- ✅ MathPrompt mathematical obfuscation (73.6% ASR)
- ✅ Emotional manipulation techniques
- ✅ Hypothetical framing attacks
- ✅ 10x variation multiplier (vs 5x in v1.0)

## Dataset Statistics

- **Total Examples**: 200,000
- **Training Set**: 150,000 (75%)
- **Validation Set**: 25,000 (12.5%)
- **Test Set**: 25,000 (12.5%)
- **Malicious Examples**: ~60,000 (30%)
- **Benign Examples**: ~140,000 (70%)
...
### 4. Synthetic Variations (~30K with 10x multiplier)
...
- **🆕 FlipAttack homoglyphs**: Cyrillic/Latin lookalikes (81-98% ASR)
- **🆕 MathPrompt**: Mathematical notation obfuscation (73.6% ASR)
- **🆕 Emotional manipulation**: Urgency, desperation appeals
- **🆕 Hypothetical framing**: "In a hypothetical scenario..."
- **Weight**: 0.8-1.5x based on sophistication

### 5. Synthetic Benign Examples (~140K)
