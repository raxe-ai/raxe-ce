...
- Any other forum created by the project team
...
As a project focused on AI safety and security, we have additional expectations:
...
### AGI Safety Discussions

- Respect diverse viewpoints on AI safety and governance
- Engage in good faith
- Base arguments on evidence and reasoning
- Acknowledge uncertainty inherent in predicting the future
...
- Open a [Discussion](https://github.com/raxe-ai/raxe-ce/discussions)
- Email: conduct@raxe.ai
- Join our [Slack](https://join.slack.com/t/raxeai/shared_invite/zt-3kch8c9zp-A8CMJYWQjBBpzV4KNnAQcQ)
...
**Thank you for helping make RAXE CE a welcoming, inclusive community!** 🙏
