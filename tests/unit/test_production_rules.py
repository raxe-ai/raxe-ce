...
class TestProductionRules:
    ...
    def test_manifest_exists(self):
        ...
        manifest_path = RULEPACK_PATH / "manifest.yaml"
        ...
        assert manifest["pack"]["version"] == "1.1.0"
        assert manifest["pack"]["total_rules"] == EXPECTED_TOTAL_RULES
    ...
    def test_rule_confidence_threshold(self, rule_file: Path):
        ...
        # All production rules should have confidence >= 0.85
        assert confidence >= 0.85, (
            f"Rule {rule_file} has confidence {confidence}, below threshold 0.85"
        )
